        ...
        <span style="font-size:13px;font-weight: bold;text-transform: capitalize">Phần Mềm Quản lý học sinh trường tiểu học Trâu Qùy - Gia Lâm &nbsp;&nbsp;&nbsp;</span>
          <div class="form-group">
            <div class="input-group">
              <input type="text" ng-model="selected" typeahead="state for state in states | filter:$viewValue | limitTo:8" class="form-control input-sm bg-light no-border rounded padder" placeholder="Tìm kiếm học sinh ...">
